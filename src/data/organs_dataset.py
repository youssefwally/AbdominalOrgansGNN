...
class OrganMeshDataset(Dataset):
    def __init__(self, config, mode='train', transform=None, pre_transform=None, pre_filter=None,
        ...
        new_names = {'*****-2.0':'age', '31-0.0':'sex', '*****-2.0':'bmi', '*****-2.0':'weight','50-2.0':'standing_height'}
    ...
    def get(self, idx):
        ...
        if self.use_registered_data:
            ...
            eid = self.bridge_organ_df[self.bridge_organ_df['eid_*****'] == int(selected_patient)]["eid_*****"].values[0]
